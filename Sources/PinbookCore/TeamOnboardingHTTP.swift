...
enum TeamOnboardingRoute: String {
    ...
    case deliveryChallenge = "deliveries/challenge", deliveryPending = "deliveries/pending"
    case deliveryFetch = "deliveries/fetch", deliveryACK = "deliveries/ack"
    case deliveryStatus = "deliveries/submit/status"
