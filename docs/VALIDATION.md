...
Simulator builds and static inspection do not prove physical-device behavior, Apple signing, Google OAuth, Drive transfer, iCloud, real notification delivery, successful transfer through a share extension, or App Store review readiness. Each implemented integration needs its own end-to-end acceptance before any release claim.
